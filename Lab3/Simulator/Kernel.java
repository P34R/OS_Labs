...
public class Kernel extends Thread
{
  ...
  private ArrayDeque memQueue = new ArrayDeque();
  ...
  public void step()
  {
    ...
    if ( instruct.inst.startsWith( "READ" ) ) 
    {
      ...
      if ( page.physical == -1 ) 
      {
        ...
        PageFault.replacePage(memQueue, memVector , virtPageNum , Virtual2Physical.pageNum( instruct.addr , virtPageNum , block ) , controlPanel );
    ...
    if ( instruct.inst.startsWith( "WRITE" ) ) 
    {
      ...
      if ( page.physical == -1 ) 
      {
        ...
        PageFault.replacePage(memQueue,memVector , virtPageNum , Virtual2Physical.pageNum( instruct.addr , virtPageNum , block ) , controlPanel );          controlPanel.pageFaultValueLabel.setText( "YES" );
      } 
      else 
      {
        page.M = 1;
